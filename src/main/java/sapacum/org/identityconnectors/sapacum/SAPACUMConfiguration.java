 ...
 *
 */
public class SAPACUMConfiguration extends SAPConfiguration {
	
	private static final Log log = Log.getLog(SAPACUMConfiguration.class);
	 ...
	 * 
	 */
	public SAPACUMConfiguration(){
		super();
	}
	
	public SAPACUMConfiguration(SAPACUMConfiguration sapConfig){
    ...
    private void validateRequired() {
        try {
            ...
            for (PropertyDescriptor propertyDescriptor : propertyDescs) {
                ...
                if (annotation != null && annotation.required()) {
                    ...
                    if (value == null) {
                        ...
                        throw new ConfigurationException(getMessage(annotation.displayMessageKey())+getMessage("SAPACUM_CE_NOT_SET"));
                    }
        	...
        	log.warn(ex, getMessage("SAPACUM_WARN_VALIDATING_REQ_PROPERTIES"));
	...
	@ConfigurationProperty(order = 74, displayMessageKey="AC_IS_GRC_53_DISPLAY", helpMessageKey="AC_IS_GRC_53_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	...
	@ConfigurationProperty(order = 75, displayMessageKey="AC_GRC_LANGUAGE_DISPLAY", helpMessageKey="AC_GRC_LANGUAGE_HELP", required=true)
	 ...
	 * @return the username
	 */
	@ConfigurationProperty(order = 76, displayMessageKey="AC_GRC_USERNAME_DISPLAY", helpMessageKey="AC_GRC_USERNAME_HELP", required=true)
	 ...
	 * @return the password
	 */
	@ConfigurationProperty(order = 77, displayMessageKey="AC_GRC_PASSWORD_DISPLAY", helpMessageKey="AC_GRC_PASSWORD_HELP", required=true, confidential=true)
	 ...
	 */
	@ConfigurationProperty(order = 78, displayMessageKey="AC_USER_ACCESS_WS_DISPLAY", helpMessageKey="AC_USER_ACCESS_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 79, displayMessageKey="AC_REQUEST_STATUS_WS_DISPLAY", helpMessageKey="AC_REQUEST_STATUS_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 80, displayMessageKey="AC_AUDIT_LOGS_WS_DISPLAY", helpMessageKey="AC_AUDIT_LOGS_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 81, displayMessageKey="AC_ENTITLEMENT_RISK_ANALYSIS_WS_DISPLAY", helpMessageKey="AC_ENTITLEMENT_RISK_ANALYSIS_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 82, displayMessageKey="AC_ROLE_LOOKUP_WS_DISPLAY", helpMessageKey="AC_ROLE_LOOKUP_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 83, displayMessageKey="AC_APP_LOOKUP_WS_DISPLAY", helpMessageKey="AC_APP_LOOKUP_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 84, displayMessageKey="AC_OTHER_LOOKUP_WS_DISPLAY", helpMessageKey="AC_OTHER_LOOKUP_WS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 85, displayMessageKey="AC_CREATE_USER_REQTYPE_DISPLAY", helpMessageKey="AC_CREATE_USER_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 86, displayMessageKey="AC_MODIFY_USER_REQTYPE_DISPLAY", helpMessageKey="AC_MODIFY_USER_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 87, displayMessageKey="AC_LOCK_USER_REQTYPE_DISPLAY", helpMessageKey="AC_LOCK_USER_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 88, displayMessageKey="AC_UNLOCK_USER_REQTYPE_DISPLAY", helpMessageKey="AC_UNLOCK_USER_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 89, displayMessageKey="AC_DELETE_USER_REQTYPE_DISPLAY", helpMessageKey="AC_DELETE_USER_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 90, displayMessageKey="AC_ASSIGN_ROLE_REQTYPE_DISPLAY", helpMessageKey="AC_ASSIGN_ROLE_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 91, displayMessageKey="AC_IGNORE_OPEN_STATUS_DISPLAY", helpMessageKey="AC_IGNORE_OPEN_STATUS_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 92, displayMessageKey="AC_LOG_AUDIT_TRIAL_DISPLAY", helpMessageKey="AC_LOG_AUDIT_TRIAL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 93, displayMessageKey="AC_USER_ACCESS_ACCESS_URL_DISPLAY", helpMessageKey="AC_USER_ACCESS_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 94, displayMessageKey="AC_REQUEST_STATUS_ACCESS_URL_DISPLAY", helpMessageKey="AC_REQUEST_STATUS_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 95, displayMessageKey="AC_AUDIT_LOGS_ACCESS_URL_DISPLAY", helpMessageKey="AC_AUDIT_LOGS_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 96, displayMessageKey="AC_ENTITLEMENT_RISK_ANALYSIS_ACCESS_URL_DISPLAY", helpMessageKey="AC_ENTITLEMENT_RISK_ANALYSIS_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 97, displayMessageKey="AC_ROLE_LOOKUP_ACCESS_URL_DISPLAY", helpMessageKey="AC_ROLE_LOOKUP_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 98, displayMessageKey="AC_APP_LOOKUP_ACCESS_URL_DISPLAY", helpMessageKey="AC_APP_LOOKUP_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 99, displayMessageKey="AC_OTHER_LOOKUP_ACCESS_URL_DISPLAY", helpMessageKey="AC_OTHER_LOOKUP_ACCESS_URL_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 100, displayMessageKey="AC_REQUEST_TYPE_ATTRNAME_DISPLAY", helpMessageKey="AC_REQUEST_TYPE_ATTRNAME_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 101, displayMessageKey="AC_PROV_ACTION_ATTRNAME_DISPLAY", helpMessageKey="AC_PROV_ACTION_ATTRNAME_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 102, displayMessageKey="AC_PROV_ITEM_ACTION_ATTRNAME_DISPLAY", helpMessageKey="AC_PROV_ITEM_ACTION_ATTRNAME_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 103, displayMessageKey="AC_REMOVE_ROLE_REQTYPE_DISPLAY", helpMessageKey="AC_REMOVE_ROLE_REQTYPE_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 104, displayMessageKey="AC_WSDL_FILE_PATH_DISPLAY", helpMessageKey="AC_WSDL_FILE_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 105, displayMessageKey="AC_AUDIT_TRIAL_WSDL_PATH_DISPLAY", helpMessageKey="AC_AUDIT_TRIAL_WSDL_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 106, displayMessageKey="AC_REQUEST_STATUS_WSDL_PATH_DISPLAY", helpMessageKey="AC_REQUEST_STATUS_WSDL_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 107, displayMessageKey="AC_SUBMIT_REQUEST_WSDL_PATH_DISPLAY", helpMessageKey="AC_SUBMIT_REQUEST_WSDL_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 108, displayMessageKey="AC_SELECT_APPLICATION_WSDL_PATH_DISPLAY", helpMessageKey="AC_SELECT_APPLICATION_WSDL_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
	 ...
	 */
	@ConfigurationProperty(order = 109, displayMessageKey="AC_SEARCH_ROLES_WSDL_PATH_DISPLAY", helpMessageKey="AC_SEARCH_ROLES_WSDL_PATH_HELP", objectClasses="ObjectClass.ACCOUNT_NAME")
