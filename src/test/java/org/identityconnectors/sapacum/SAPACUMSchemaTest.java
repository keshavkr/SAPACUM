...
public class SAPACUMSchemaTest {

	
	private  Schema schema;
	private static final Log LOGGER = Log.getLog(SAPACUMSchemaTest.class);
	private static ObjectClassInfo uoci,proci,paoci,agoci;
	...
	public void setUp() throws Exception {
		...
		schema=ICFTestHelper.getConnectorFacadeHelperImp().schema();
	...
	@Test
	public void testACSchema_Attributes() throws Exception {
